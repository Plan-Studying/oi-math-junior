...
\begin{enumerate}
\item $\sum$：读作“求和”，$\sum\limits_{i=1}^n a_i$ 代表 $a_1 + a_2 + \dots + a_n$；
\item $\prod$：读作“求积”，$\prod\limits_{i=1}^n a_i$ 代表 $a_1  a_2 \dots a_n$；
...
b &(a > b)
\end{cases}$；
\item $n!$：读作“阶乘”，$n! = \prod\limits_{i=1}^n i$。
\end{enumerate}
...
\item $\binom{n}{m}$ 或 $\operatorname{C}_n^m$：组合数，见 5.2。
\end{enumerate}